...
export type GetEconomyTotalsQuery = {
  __typename?: "Query"
  economyExchangeLordsPurchasedTotal: string
  economyResourceMintedTotals: Array<{
    __typename?: "ResourceAmount"
    resourceId: number
    resourceName: string
    amount: string
  }>
  economyResourceBurnedTotals: Array<{
    __typename?: "ResourceAmount"
    resourceId: number
    resourceName: string
    amount: string
  }>
  economyLpResourceMintedTotals: Array<{
    __typename?: "ResourceAmount"
    resourceId: number
    resourceName: string
    amount: string
  }>
  economyLpResourceBurnedTotals: Array<{
    __typename?: "ResourceAmount"
    resourceId: number
    resourceName: string
    amount: string
  }>
  economyExchangeResourcePurchasedTotals: Array<{
    __typename?: "ResourceAmount"
    resourceId: number
    resourceName: string
    amount: string
 ...
 * });
 */
export function useGetEconomyTotalsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetEconomyTotalsQuery,
    GetEconomyTotalsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>(
    GetEconomyTotalsDocument,
    options
  )
}
export function useGetEconomyTotalsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetEconomyTotalsQuery,
    GetEconomyTotalsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetEconomyTotalsQuery,
    GetEconomyTotalsQueryVariables
  >(GetEconomyTotalsDocument, options)
}
export type GetEconomyTotalsQueryHookResult = ReturnType<
  typeof useGetEconomyTotalsQuery
>
export type GetEconomyTotalsLazyQueryHookResult = ReturnType<
  typeof useGetEconomyTotalsLazyQuery
>
export type GetEconomyTotalsQueryResult = Apollo.QueryResult<
  GetEconomyTotalsQuery,
  GetEconomyTotalsQueryVariables
>
