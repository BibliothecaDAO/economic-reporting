...
export type GetEconomyTotalsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEconomyTotalsQuery = { __typename?: 'Query', economyExchangeLordsPurchasedTotal: string, economyResourceMintedTotals: Array<{ __typename?: 'ResourceAmount', resourceId: number, resourceName: string, amount: string }>, economyResourceBurnedTotals: Array<{ __typename?: 'ResourceAmount', resourceId: number, resourceName: string, amount: string }>, economyLpResourceMintedTotals: Array<{ __typename?: 'ResourceAmount', resourceId: number, resourceName: string, amount: string }>, economyLpResourceBurnedTotals: Array<{ __typename?: 'ResourceAmount', resourceId: number, resourceName: string, amount: string }>, economyExchangeResourcePurchasedTotals: Array<{ __typename?: 'ResourceAmount', resourceId: number, resourceName: string, amount: string }> };
...
export const GetEconomyTotalsDocument = gql`
...
/**
 * __useGetEconomyTotalsQuery__
 *
 * To run a query within a React component, call `useGetEconomyTotalsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetEconomyTotalsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetEconomyTotalsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetEconomyTotalsQuery(baseOptions?: Apollo.QueryHookOptions<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>(GetEconomyTotalsDocument, options);
      }
export function useGetEconomyTotalsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>(GetEconomyTotalsDocument, options);
        }
export type GetEconomyTotalsQueryHookResult = ReturnType<typeof useGetEconomyTotalsQuery>;
export type GetEconomyTotalsLazyQueryHookResult = ReturnType<typeof useGetEconomyTotalsLazyQuery>;
export type GetEconomyTotalsQueryResult = Apollo.QueryResult<GetEconomyTotalsQuery, GetEconomyTotalsQueryVariables>;
 ...
 * });
 */
export function useGetWalletBalancesQuery(baseOptions: Apollo.QueryHookOptions<GetWalletBalancesQuery, GetWalletBalancesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWalletBalancesQuery, GetWalletBalancesQueryVariables>(GetWalletBalancesDocument, options);
      }
export function useGetWalletBalancesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWalletBalancesQuery, GetWalletBalancesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWalletBalancesQuery, GetWalletBalancesQueryVariables>(GetWalletBalancesDocument, options);
        }
export type GetWalletBalancesQueryHookResult = ReturnType<typeof useGetWalletBalancesQuery>;
export type GetWalletBalancesLazyQueryHookResult = ReturnType<typeof useGetWalletBalancesLazyQuery>;
export type GetWalletBalancesQueryResult = Apollo.QueryResult<GetWalletBalancesQuery, GetWalletBalancesQueryVariables>;